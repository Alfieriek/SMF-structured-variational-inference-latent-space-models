#----------------------------------------------------------------------------
# Binary network via SMF variational inference with missed edges for inverse gamma prior transition variance
# Input Variables:
...
# Ind: indicator matrix specifying the missed edges

mix_DN_adaptive_invgamma = function(Y,mean_beta_prior=0, sigma_beta_prior=sqrt(10),  gap = 0.01 ,min_iter=1 ,rho=1,alpha=0.95, trans_sd_init =0.1, Ind){
