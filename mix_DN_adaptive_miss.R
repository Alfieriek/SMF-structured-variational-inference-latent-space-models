#----------------------------------------------------------------------------
# Binary network via SMF variational inference for missed edges
# Input Variables:
...
mix_DN_adaptive = function(Y,mean_beta_prior=0, sigma_beta_prior=sqrt(10),  gap = 0.01 ,min_iter=1 ,rho=1,alpha=0.95, trans_sd_init =1,Ind){
