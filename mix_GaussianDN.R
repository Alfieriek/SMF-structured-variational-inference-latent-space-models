#----------------------------------------------------------------------------
# Gaussian network via PMP variational inference
# Input Variables:
...
mix_GaussianDN = function(Y,trans_sd ,mean_beta_prior, sigma_beta_prior,rho=1, sigma_X1 ,sigma,  gap = 0.001, max_iter=10, alpha=0.95){
